...
def get_accounts(account_id):
    ...
    # Jika ketemu, kembalikan data dalam bentuk JSON
...
def update_accounts(account_id):
    """
    Update an Account
    This endpoint will update an Account based on the id that is posted
    """
...
def delete_accounts(account_id):
    """
    Delete an Account
    This endpoint will delete an Account based on the id requested
    """
